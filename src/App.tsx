...
function App() {
  ...
  function SidebarMenu({ icon, text }: { icon: React.ReactNode, text: string }) {
    return (
      <>
        <div className={`sidebar-menu-container ${text === activeMenu ? 'font-bold' : ''}`} onClick={() => setActiveMenu(text)}>
          {icon}
        ...
        <div className='sidebar-container'>
          ...
          <div className='sidebar-header'>
            ...
            <div className='sidebar-header-menu'>
              <SidebarMenu icon={<HomeIcon activated={activeMenu === "Home"} />} text="Home" />
              <SidebarMenu icon={<SearchIcon activated={activeMenu === "Search"} />} text="Search" />
              <SidebarMenu icon={<ExploreIcon activated={activeMenu === "Explore"} />} text="Explore" />
              <SidebarMenu icon={<ReelsIcon activated={activeMenu === "Reels"} />} text="Reels" />
              <SidebarMenu icon={<MessagesIcon activated={activeMenu === "Messages"} />} text="Messages" />
              <SidebarMenu icon={<NotificationsIcon activated={activeMenu === "Notifications"} />} text="Notifications" />
              <SidebarMenu icon={<CreateIcon />} text="Create" />
            </div>
          </div>
...
function HomeIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
      ...
      :
      <svg aria-label="Home" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Home</title><path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
    )
  )
}

function SearchIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
      <svg aria-label="Search" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Search</title><path d="M18.5 10.5a8 8 0 1 1-8-8 8 8 0 0 1 8 8Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" x1="16.511" x2="21.643" y1="16.511" y2="21.643"></line></svg>
      :
...
function ExploreIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
...
function ReelsIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
...
function MessagesIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
...
function NotificationsIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
...
function CreateIcon() {
  return (
    <svg aria-label="New post" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>New post</title><path d="M2 12v3.45c0 2.849.698 4.005 1.606 4.944.94.909 2.098 1.608 4.946 1.608h6.896c2.848 0 4.006-.7 4.946-1.608C21.302 19.455 22 18.3 22 15.45V8.552c0-2.849-.698-4.006-1.606-4.945C19.454 2.7 18.296 2 15.448 2H8.552c-2.848 0-4.006.699-4.946 1.607C2.698 4.547 2 5.703 2 8.552Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="6.545" x2="17.455" y1="12.001" y2="12.001"></line><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="12.003" x2="12.003" y1="6.545" y2="17.455"></line></svg>
  )
}

function MoreIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
      <svg aria-label="Settings" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Settings</title><path d="M3.5 6.5h17a1.5 1.5 0 0 0 0-3h-17a1.5 1.5 0 0 0 0 3Zm17 4h-17a1.5 1.5 0 0 0 0 3h17a1.5 1.5 0 0 0 0-3Zm0 7h-17a1.5 1.5 0 0 0 0 3h17a1.5 1.5 0 0 0 0-3Z"></path></svg>
      :
...
function AlsoFromMetaIcon({ activated }: { activated: boolean }) {
  return (
    (activated ?
